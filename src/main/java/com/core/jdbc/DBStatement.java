...
public class DBStatement {
	...
	public DBStatement() {
		try {
			...
			String mySqlUrl = "jdbc:mysql://localhost:3306/hadooptest?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useOldAliasMetadataBehavior=true";
